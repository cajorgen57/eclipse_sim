"""Eclipse game rules engine for action generation.

This module implements the core Eclipse game rules and generates all legal actions
for a player based on the current game state. It handles:
- Exploration (sector discovery and placement)
- Research (technology acquisition with discounts)
- Building (ships and starbases)
- Movement (including combat initiation)
- Influence (claiming planets and managing colonies)
- Diplomacy (forming and breaking alliances)
- Upgrades (ship blueprint modifications)
"""
