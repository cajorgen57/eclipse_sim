"""Exploration turn state management and execution.

This module manages the state and actions during exploration turns in Eclipse,
including choosing exploration targets, drawing sector tiles, and placing them.
"""
