...
- **Comprehensive Evaluation**: 80+ game state features for intelligent decision-making
- **Strategy Profiles**: 8 pre-configured playstyles (aggressive, economic, tech rush, etc.)
- **Improved Defaults**: Better out-of-box performance with tuned parameters
...
optimal plans using progressive widening Monte Carlo tree search.
