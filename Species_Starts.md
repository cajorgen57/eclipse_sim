...
```json
{
  "name": "Eridani Empire",
  "starting_sector": 224,
  "starting_resources": {"money": 26, "science": 3, "materials": 4},
  "starting_ships": {"interceptor": 1, "cruiser": 0},
...
```json
{
  "name": "Hydrans",
  "starting_sector": 226,
  "starting_resources": {"money": 3, "science": 5, "materials": 2},
  "starting_colonies": {"home": {"science": 2, "materials": 1}},
  "starting_ships": {"interceptor": 21 "cruiser": 0, "dreadnought": 0, "starbase": 0},
...
```json
{
  "name": "Planta",
  "starting_sector": 228,
  "starting_resources": {"money": 4, "science": 3, "materials": 3},
